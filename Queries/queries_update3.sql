...
--Creating new table to hold our data of interest
SELECT first_name, last_name
...
-- Employee count by department number organizes
SELECT COUNT(ce.emp_no), de.dept_no
...
-- creating new table for data of interest
SELECT COUNT(ce.emp_no), de.dept_no
INTO  retiring_dept
FROM current_emp as ce
LEFT JOIN dept_employees as de
...
-- Creating new table called emp_info for data of interest
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
